functions {
  ...
  int[]  x_i 
    ...
    for(tx in 1:numTaxa){
      ...
      // print("tx:",tx)
      // print("solidDependency: ", solidDependency)
      // print("HMODependency: ", HMODependency)
      // print("O2Dependency: ", O2Dependency)
      // print("growthRate: ", growthRate)
      // print("growthRate_net: ", growthRate_net)
      // print("theta: ", theta[tx])
      // print("level_mIgA: ",level_mIgA)
      
      
      // UNCOATED
      dydt[tx]          = theta[tx]*(0.01* y[tx]);
      
      // COATED
      dydt[tx+numTaxa]  = theta[tx]*(0.01* y[tx+numTaxa]);
      
      // // UNCOATED
      // dydt[tx]          = theta[tx]*(1-level_mIgA)*(growthRate_net * y[tx] + interactions);
      // 
      // // COATED
      // dydt[tx+numTaxa]  = theta[tx]*(level_mIgA)*(growthRate_net * y[tx+numTaxa] + interactions);
