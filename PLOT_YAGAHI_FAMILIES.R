...
graphics.off()
  png(file =paste0("/Users/burcutepekule/Library/CloudStorage/Dropbox/criticalwindow/code/R/RStan/YAGAHI_DATA/FIGS/FAMILY_",taxonomy_pick,".png"),   # The directory you want to save the file in
      width     = 8,
      height    = 3,
      units     = "in",
      res       = 300)
